...
5. Опять почему то не работает логика левелов, если достиг последнего, цитаты не получается добавить
6. сделать логику по токенам чтобы обновлялись

# Закомитить

1. Добавить поиск на сам сайт / Added the search form in the main page of site
2. Добавить поделиться в профиле / Added the share form in the profile page
